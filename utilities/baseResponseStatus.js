module.exports = {
  ...
  ACCESS_TOKEN_EMPTY: {
    isSuccess: false,
    code: 308,
    message: "refresh token 만료, 새 AccessToken이 필요합니다.",
  },

  //Request error

  SIGNIN_ERROR: { isSuccess: false, code: 199, message: "회원가입을 해주세요" },
  SIGNIN_PASSWORD_TYPE: {
    isSuccess: false,
    code: 201,
  ...
  USER_USERID_EXIST: {
    isSuccess: false,
    code: 226,
    message: "해당 아이디를 사용한 회원이 존재합니다.",
  },
  USER_USERID_LENGTH: {
    isSuccess: false,
    code: 227,
    message: "userId는 최대 20자리를 입력해주세요.",
  },
  USER_USERID_SHORT: {
    isSuccess: false,
    code: 228,
    message: "userId는 최소 3자리 이상 입력해주세요.",
  },
  ...
  USER_PHONENUMBER_LENGTH: {
    isSuccess: false,
    code: 230,
    message: "전화번호 길이를 확인해주세요.",
  },
  USER_PHONENUMBER_NOT_MATCH: {
    isSuccess: false,
    code: 231,
  ...
  POST_CONTENT_LENGTH: {
    isSuccess: false,
    code: 241,
    message: "content의 길이는 450자 이하로 입력해주세요.",
  },
  POST_POSTIDX_EMPTY: {
    isSuccess: false,
    code: 242,
  ...
  COMMENT_COMMENTIDX_EMPTY: {
    isSuccess: false,
    code: 248,
    message: "commentIdx를 입력해주세요.",
  },
  COMMENT_COMMENTIDX_LENGTH: {
    isSuccess: false,
    code: 249,
    message: "commentIdx는 0보다 큰 값으로 입력해주세요.",
  },
  COMMENT_STATUS_INACTIVE: {
    isSuccess: false,
    code: 250,
  ...
  WRITER_NOT_MATCH: {
    isSuccess: false,
    code: 251,
    message: "작성자와 사용자가 일치하지 않습니다",
  },
  MESSAGE_USERIDX_EMPTY: {
    isSuccess: false,
    code: 252,
    message: "메시지 상대 userIdx가 오지 않았습니다.",
  },
  MESSAGE_USERIDX_LENGTH: {
    isSuccess: false,
    code: 253,
    message: "메시지 상대 userIdx길이를 확인해주세요",
  },
  ...
  MESSAGE_CONTENT_LENGTH: {
    isSuccess: false,
    code: 255,
    message: "메시지 내용은 200자 이하로 입력해주세요.",
  },

  REPORT_CODE_EMPTY: {
    isSuccess: false,
    code: 270,
    message: "신고 구분이 입력되지 않았습니다",
  },
  REPORT_ENTERED: {
    isSuccess: false,
    code: 271,
  ...
  REPORT_COMMENT_MYSELF: {
    isSuccess: false,
    code: 273,
    message: "본인이 작성한 댓글입니다",
  },

  PAGENATION_ERROR: {
    isSuccess: false,
    code: 290,
    message: "보고싶은 페이지를 입력해주세요. ",
  },
  REQUEST_CODE_EMPTY: {
    isSuccess: false,
    code: 291,
    message: "요청코드를 입력해주세요.",
  },
  REQUEST_CODE_ERROR: {
    isSuccess: false,
    code: 293,
    message: "요청코드를 정확히 입력해주세요.",
  },
  ADMIN_DATE_REGEX: {
    isSuccess: false,
    code: 294,
    message: " 날짜 형식이 옳지 않습니다.",
  },

  REPORT_MYPOST: {
    isSuccess: false,
    code: 295,
    message: " 자기 자신의 댓글/게시글입니다",
  },
  ...
  FOLLOW_REQUEST_EMPTY: {
    isSuccess: false,
    code: 308,
    message: "사라진 팔로우 요청입니다",
  },
  FOLLOW_EXISTS: {
    isSuccess: false,
    code: 309,
    message: "이미 팔로우중인 사용자입니다.",
  },
  ...
  // Admin Page Error
  REPORT_POSTREPORTIDX_EMPTY: {
    isSuccess: false,
    code: 500,
    message: "postReportIdx를 입력해주세요",
  },
  REPORT_POSTREPORTIDX_LENGTH: {
    isSuccess: false,
    code: 501,
    message: "postReportIdx는 0보다 큰 값으로 입력해주세요.",
  },

  REPORT_COMMENTREPORT_EMPTY: {
    isSuccess: false,
    code: 502,
    message: "commentReportIdx를 입력해주세요",
  },
  REPORT_COMMENTREPORT_LENGTH: {
    isSuccess: false,
    code: 503,
    message: "commentReportIdx는 0보다 큰 값으로 입력해주세요.",
  },
};
